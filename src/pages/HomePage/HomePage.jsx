      ...
      <section className="hero-section-container">
        <div className="hero-headline-container">
          ...
          <animated.p style={heroAnimation4}>
            {language === "EN" ? (
              <>
                Design and technology interest me since I was a little kid when
                I was very passionate about drawing and playing with Legos.
                Things need to be functional but also need to look good, that
                was my motto and is to this day.
              </>
            ) : (
              <>
                Design und Technologie begleiten mich schon seit meiner
                Kindheit, als ich noch gern gezeichnet oder mit Legos gespielt
                habe. Für mich müssen die Dinge funktional sein, aber eben auch
                gut aussehen. Das war mein Motto und ist es bis heute.
              </>
            )}
          </animated.p>
